package com.vitalii.movieapplication.data;
...
import com.vitalii.movieapplication.R;
import com.vitalii.movieapplication.model.Movie;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    //Доступ к XML разметке (movie_item.xml)
