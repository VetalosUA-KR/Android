...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NotesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
        ...
        //holder.textViewDayOfWeak.setText(getDayAsString(note.getDayOfWeak()+1));
        /*int colorId;
    ...
    class NotesViewHolder extends RecyclerView.ViewHolder {
        ...
        public NotesViewHolder(@NonNull View itemView) {
            ...
            //textViewDayOfWeak = itemView.findViewById(R.id.textViewDayOfWeek);
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    return true;// true для того чтобы сработало только событие долгого нажатия
                }
            });
        }
    }
